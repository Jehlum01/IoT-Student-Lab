# 08 — LED Toggle / Electronic Switch

> **IoT Student Lab · Learning Project**

## 🎯 Project Overview

Create a software-controlled electronic switch using state variables.

This project is part of **Level 2 — Sensors, Inputs & Automation** and is designed around a hands-on engineering workflow:
...
| Main concept | State & toggle logic |
