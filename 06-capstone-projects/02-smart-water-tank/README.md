# 02 — Smart Water Tank Level Controller

> **IoT Student Lab · Capstone Project**

## 🎯 Project Overview

Measure tank level and automatically control a pump between defined operating thresholds.

This project is part of **Capstone Projects** and is designed around a hands-on engineering workflow:
...
| Main concept | Water management |
| Estimated time | Instructor-defined |
| Project type | Capstone / integrated system |
